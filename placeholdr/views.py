		...
		if place:
			...
			return render(request,
						  ...
						  {'place': place, 'reviews': place_reviews, 'mapsUrl': mapsUrl, 'review_inf': review_inf,
						   'stars': place.get_stars(), 'review_dict': review_dict, "nbr_reviews": nbr_reviews, "submitter": submitter, "following":following})
		else:
		...
		if trip:
			...
			return render(request, 'placeholdr/trip.html',
						  {'trip': trip, 'places': places, 'trip_nodes': trip_nodes, 'mapsUrl': mapsUrl,
						   ...
						   "review_dict": review_dict, "nbr_reviews": nbr_reviews, "submitter": submitter, "following":following})
		else:
